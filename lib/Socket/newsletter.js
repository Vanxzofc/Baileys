...
const izumi = groups_1.makeGroupsSocket(config)
const { authState, signalRepository, query, generateMessageTag } = izumi
...
tag: 'notice',
attrs: {
id: '20601218', // ID TOS internal WA
stage: '5'// Stage bisa berubah sesuai versi server WA
},
content: []
}
]
...
name,
description,
settings: null // bisa dikembangkan nanti untuk set `audience`, `visibility`,
}
})
